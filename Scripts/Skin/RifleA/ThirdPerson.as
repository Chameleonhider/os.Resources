...
namespace spades 
{
	...
	IToolSkin, IThirdPersonToolSkin, IWeaponSkin 
	{
		...
		{			
			...
			//0 18 6
			mat = CreateTranslateMatrix(0.35, -0.3, -0.2) * mat;
	...
	IWeaponSkin@ CreateThirdPersonRifleSkinA(Renderer@ r, AudioDevice@ dev) {
		return ThirdPersonRifleSkinA(r, dev);
	}
}
