 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IThirdPersonToolSkin, IWeaponSkin 
	{
		...
		ThirdPersonShotgunSkinB(Renderer@ r, AudioDevice@ dev) {
			...
			@model = renderer.RegisterModel
				("Models/Weapons/ShotgunB/Weapon3rd.kv6");
				
			@fire0 = dev.RegisterSound
				("Sounds/Weapons/ShotgunB/Fire0.wav");
			@fire1 = dev.RegisterSound
				("Sounds/Weapons/ShotgunB/Fire1.wav");
			@fire2 = dev.RegisterSound
				("Sounds/Weapons/ShotgunB/Fire2.wav");
	...
	IWeaponSkin@ CreateThirdPersonShotgunSkinB(Renderer@ r, AudioDevice@ dev) {
		return ThirdPersonShotgunSkinB(r, dev);
	}
}
