...
namespace spades
{
	...
	BasicViewWeapon
	{
		...
		ViewRifleSkinB(Renderer@ r, AudioDevice@ dev){
			...
			//	("Models/Weapons/RifleB/Magazine.kv6");
		...
		void AddToScene() 
		{
			...
			if(AimDownSightStateSmooth > 0.f)
			{
				...
				mat = AdjustToAlignSight(mat, Vector3(0.f, 16.f, -1.472f+ConfigItem("d_z", "0").FloatValue), AimDownSightStateSmooth);
				//-4.6*0.25=-1.15
			}
			...
			//Chameleon
			{
				...
				Vector3 posF = (weapMatrix * CreateTranslateMatrix(0.f, distF, ConfigItem("d_c", "1").FloatValue)).GetOrigin();
				Vector3 posM = (weapMatrix * CreateTranslateMatrix(0.f, distM, ConfigItem("d_c", "1").FloatValue)).GetOrigin();
				Vector3 posC = (weapMatrix * CreateTranslateMatrix(0.f, distC, ConfigItem("d_c", "1").FloatValue)).GetOrigin();
			...
			weapMatrix *= CreateTranslateMatrix(0.f, 0.f, 10.f);
			// draw weapon
