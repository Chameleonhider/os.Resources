 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IViewToolSkin, IGrenadeSkin {
		...
		ViewGrenadeSkinA(Renderer@ r, AudioDevice@ dev) {
			@renderer = r;
			@audioDevice = dev;
			@model = renderer.RegisterModel
				("Models/Weapons/GrenadeA/Grenade1st.kv6");
	...
	IGrenadeSkin@ CreateViewGrenadeSkinA(Renderer@ r, AudioDevice@ dev) {
		return ViewGrenadeSkinA(r, dev);
	}
}
