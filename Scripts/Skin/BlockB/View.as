 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IViewToolSkin, IBlockSkin {
		...
		ViewBlockSkinB(Renderer@ r, AudioDevice@ dev) {
			@renderer = r;
			@audioDevice = dev;
			@model = renderer.RegisterModel
				("Models/Weapons/BlockB/Block1st.kv6");
	...
	IBlockSkin@ CreateViewBlockSkinB(Renderer@ r, AudioDevice@ dev) {
		return ViewBlockSkinB(r, dev);
	}
}
